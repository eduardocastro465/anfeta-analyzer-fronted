...
export function MessageList({
  ...
  useEffect(() => {
    ...
    console.log('🔌 Conectando WebSocket para tareas reportadas...');
    ...
    wsService.on('reportes-actualizados', (data) => {
  ...
  // ✅ ELIMINAMOS EL INTERVALO DE POLLING (líneas 290-300 aproximadamente)
  // El useEffect con setInterval ha sido eliminado y reemplazado por WebSocket
